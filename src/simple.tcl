...
$ns duplex-link $n4 $n9 15Mb 70ms DropTail
$ns duplex-link $n9 $n14 15Mb 70ms DropTail
...
$ns attach-agent $n0 $rcvr1
$ns at 1.0 "$n0 join-group $rcvr1 $group1"
...
$ns at 1.0 "$n5 join-group $rcvr2 $group2"
...
$ns attach-agent $n10 $rcvr3
$ns at 1.0 "$n10 join-group $rcvr3 $group3"
